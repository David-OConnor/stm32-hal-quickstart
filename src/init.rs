...
// pub fn run(cx: app::init::Context) -> (Shared, Local) {
    ...
    let mut tick_timer = Timer::new_tim1(
        dp.TIM1,
        1. / TICK_TIMER_PERIOD,
        Default::default(),
        &clock_cfg,
    ...
    // todo: Enable//! This module contains initialization code, run once at program start.
...
pub fn run() {
    ...
    unsafe {
        ...
        cp.NVIC.set_priority(pac::Interrupt::TIM1_CC, 8); // Tick
